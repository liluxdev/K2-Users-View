...
class K2HelperJlkUsers {
	...
	function getFirstLetters($params) {
		...
		$query.=" AND UPPER(LEFT(ju.name, 1)) IN (".K2HelperJlkUsers::quotedLetters($params->get('indexLetters')).")";
		...
		$query.=" AND UPPER(LEFT(ju.name, 1)) NOT IN (".K2HelperJlkUsers::quotedLetters($params->get('indexLetters')).")";
